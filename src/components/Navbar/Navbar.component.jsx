        ...
        <>
            <div className="text-white flex items-center justify-between">
                <div>
                    ...
                    <span className="text-gray-300 text-xs flex items-center">Jodhpur <BiChevronRight /></span>
                </div>
        ...
        <>
            <div className="container mx-auto px-5 flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                    <span className="text-gray-200 cursor-pointer hover:text-white text-md flex items-center">Jodhpur <MdArrowDropDown /></span>
                    <button className="bg-navBtn-300 text-white text-sm rounded px-3 py-1">Sign in</button>
